            ...
            foreach (var combination in settings.combinations)
            {
                ...
                if (isDevelopmentBuild || settings.aotSettingsForTarget.EnableDebugInAllBuilds)
                {
                    ...
                    options.Add(GetOption(OptionDebug,
                        settings.aotSettingsForTarget.DebugDataKind == DebugDataKind.Full ? "Full" : "LineOnly"));
                }
...
");
        ...
        internal struct BurstOutputCombination
        {
            ...
            public BurstOutputCombination(string outputPath, TargetCpus targetCpus, string libraryName = DefaultLibraryName, bool collateDirectory = false)
            {
